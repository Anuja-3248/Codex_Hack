...
const stats = [
  { label: "Assessment Score", value: 72, suffix: "%", icon: ClipboardCheck },
          ...
          <Card className="overflow-hidden">
            <CardHeader className="relative">
              ...
              <div className="relative">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
                  Your latest scan shows strong momentum in frontend development
                  and a few high-value gaps to close before internship readiness.
                </p>
              </div>
            </CardHeader>
            <CardContent className="relative grid gap-4 pt-0 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-white/10 bg-white/[0.04] p-4">
                ...
                <Progress value={analysis.careerReadiness} className="mt-4" />
              </div>
            </CardContent>
          </Card>
